<template>
  <div>
         <div style="background:#2e2f32; padding:10px; text-align:center">
          ...
          @close="handleClose"
           ...
           active-text-color="#ffd04b">
            <el-menu-item index="/home/main">
              <span slot="title" style="color:#adafb5">首页</span>
            </el-menu-item>
             <el-submenu index="1">
        <template slot="title">
          <span>内容管理</span>
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="/home/source">素材管理</el-menu-item>
        </el-menu-item-group>
      </el-submenu>
         <el-submenu index="2">
        <template slot="title">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="/home/message">账户信息</el-menu-item>
